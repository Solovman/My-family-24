...
<!--                    --><?php //= GetMessage('UP_HEADER_NAV_EXPORT') ?>
                    <svg width="30px" height="30px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <rect x="0" fill="none" width="20" height="20"/>
                        <g>
                            <style>.st0{fill-rule:evenodd;clip-rule:evenodd;}</style>
                            <path fill="#18873f" d="M5.8 14H5v1h.8c.3 0 .5-.2.5-.5s-.2-.5-.5-.5zM11 2H3v16h13V7l-5-5zM7.2 14.6c0 .8-.6 1.4-1.4 1.4H5v1H4v-4h1.8c.8 0 1.4.6 1.4 1.4v.2zm4.1.5c0 1-.8 1.9-1.9 1.9H8v-4h1.4c1 0 1.9.8 1.9 1.9v.2zM15 14h-2v1h1.5v1H13v1h-1v-4h3v1zm0-2H4V3h7v4h4v5zm-5.6 2H9v2h.4c.6 0 1-.4 1-1s-.5-1-1-1z"/>
                        </g>
                    </svg>
                </a>
            </li>
            <li class="header__nav-item">
                <a href="#" class="header__nav-link">
<!--                    --><?php //= GetMessage('UP_HEADER_NAV_STATISTIC') ?>
                    <svg width="30px" height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <style>.a{fill:none;stroke:#18873f;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;}</style>
                        </defs>
...
<!--                    --><?php //= GetMessage('UP_HEADER_NAV_BUY_SUBSCRIPTION') ?>
            ...
            <li class="header__nav-item">
                <a href="#" class="header__nav-link">
<!--                    --><?php //= GetMessage('UP_HEADER_NAV_MY_TREES')?>
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         width="30px" height="30px" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                    <g>
                        <path fill="#18873f" d="M91.963,80.982l0.023-0.013l-7.285-12.617h2.867v-0.013c0.598,0,1.083-0.484,1.083-1.082
            ...
            <li class="header__nav-item">
                <a href="#" class="header__nav-link">
<!--                    --><?php //= GetMessage('UP_HEADER_NAV_LOGOUT') ?>
    ...
    <div class="container">
        <div class="header__main">
            ...
            <div class="header__icon">
                <img class="header__image-icon" src="/local/modules/up.familyTree/images/user_default.png" alt="user-icon">
