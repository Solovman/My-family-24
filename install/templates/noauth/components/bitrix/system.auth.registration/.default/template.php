					...
					<table class="data-table bx-registration-table">
						...
						<tr>
							...
							<td class="main__container-input">
								...
								<input autocomplete="off" placeholder="<?= GetMessage('REGISTER_PLACEHOLDER_NANE') ?>" type="text" name="USER_NAME" maxlength="50" value="<?=$arResult["USER_NAME"]?>" class="bx-auth-input main__input-form-reg" />
							</td>
						</tr>
						<tr>
							...
							<td class="main__container-input">
								...
								<input autocomplete="off" type="text" placeholder="<?= GetMessage('REGISTER_PLACEHOLDER_SURNAME') ?>" name="USER_LAST_NAME" maxlength="50" value="<?=$arResult["USER_LAST_NAME"]?>" class="bx-auth-input main__input-form-reg" />
							</td>
						</tr>
						<?php if($arResult["EMAIL_REGISTRATION"]):?>
							<tr>
								...
								<td class="main__container-input">
									...
									<input autocomplete="off" class="bx-auth-input main__input-form-reg" placeholder="<?= GetMessage('REGISTER_PLACEHOLDER_EMAIL') ?>" type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="bx-auth-input" />
								</td>
							</tr>
						<?php endif?>
						<tr>
