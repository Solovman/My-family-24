<ul id="tab_2" class="subscriptions__purchase subscriptions__tabs-item">
	<li class="subscriptions__purchase-item">
		<div class="center">
				...
				<div class="content">
					...
					<div class="field filed-purchase">
						<button class="subscriptions__purchase-button has-tooltip">
							...
							<span class="buy-text"><?= GetMessage('UP_TREE_SUBSCRIPTIONS_BUY_BUTTON') ?></span>
						</button>
						<span class='tooltip blue tooltip-purchase'>
							<?= GetMessage('UP_TREE_SUBSCRIPTIONS_BUY_TEXT') ?>
						</span>
					</div>
				</div>
				<img src="/local/modules/up.tree/images/template_1.png" alt="template_1" />
			</div>
		</div>
	</li>
	<li class="subscriptions__purchase-item">
		<div class="center">
			<div class="article-card">
				...
				<img src="/local/modules/up.tree/images/template_2.png" alt="template_2"/>
			</div>
		</div>
	</li>
	<li class="subscriptions__purchase-item">
		<div class="center">
			<div class="article-card">
				...
				<img src="/local/modules/up.tree/images/template_3.png" alt="template_2" />
			</div>
		</div>
	</li>
	<li class="subscriptions__purchase-item">
		<div class="center">
			<div class="article-card">
				...
				<img src="/local/modules/up.tree/images/dark-theme.png" alt="dark-theme" />
			</div>
		</div>
	</li>
</ul>