...
<!--					<a href="/tree/--><?php //= $tree->getId()?><!--/" class="card-header-title">-->
<!--						--><?php //= htmlspecialcharsEx($tree->getTitle()) ?>
<!--					</a>-->
<!--				</header>-->
<!--				<footer class="card-footer">-->
<!--					<span class="card-footer-item is-size-6">-->
<!--						<strong>Created at</strong>: --><?php //= $tree->getCreatedAt()->format($arResult['DATE_FORMAT']) ?>
<!--					</span>-->
<!--				</footer>-->
<!--			</div>-->
<!--		</div>-->
