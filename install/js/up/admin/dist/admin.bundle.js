...
(function (exports,main_core) {
	...
	var RenderForm = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(RenderForm, null, [{
	    ...
	    value: function render(data) {
	      return main_core.Tag.render(_templateObject || (_templateObject = babelHelpers.taggedTemplateLiteral(["\n\t\t<div class=\"sign-up-modal\">\n\t\t\t<div class=\"logo-container\">\n\t\t\t\t<svg height=\"90px\" width=\"90px\" version=\"1.1\" id=\"_x32_\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" \n\t\t\t\tviewBox=\"0 0 512 512\"  xml:space=\"preserve\">\n\t\t\t\t\t<style type=\"text/css\">\n\t\t\t\t\t.st0{fill:#fff;}\n\t\t\t\t\t</style>\n\t\t\t\t\t<g>\n\t\t\t\t\t\t<path class=\"st0\" d=\"M465.771,234.587c0-26.914-10.749-51.289-28.142-69.166c0.629-4.688,1.075-9.437,1.075-14.301\n\t\t\t\t\t\tc0-54.151-40.625-98.726-93.05-105.14C319.308,17.754,281.874,0,240.206,0C160.476,0,95.853,64.624,95.853,144.361\n\t\t\t\t\t\tc0,0.422,0.062,0.821,0.062,1.236c-29.975,20.27-49.686,54.58-49.686,93.494c0,53.346,37.08,97.937,86.842,109.667\n\t\t\t\t\t\tc10.089,24.69,34.318,42.106,62.636,42.106c10.557,0,20.508-2.486,29.407-6.798V512h77.528v-83.988l30.236-51.657\n\t\t\t\t\t\tc30.95-2.256,57.097-21.766,68.743-49.033C439.087,313.128,465.771,277.022,465.771,234.587z M260.615,342.229\n\t\t\t\t\t\tc0.66,0.928,1.343,1.826,2.041,2.724l-3.43,1.396C259.725,344.984,260.208,343.625,260.615,342.229z M284.874,405.402v-40.579\n\t\t\t\t\t\tc7.181,4.366,15.076,7.642,23.492,9.622L284.874,405.402z\"/>\n\t\t\t\t\t</g>\n\t\t\t\t</svg>\n\t\t\t</div>\n\t\t\t\n\t\t\t<form class=\"details\">\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"name\">", "</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"name\" type=\"text\" placeholder=\"", "\"/>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"price\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"price\" type=\"number\" placeholder=\"", "\" min=\"0\"/>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t<div class=\"input-container-number\">\n\t\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t\t<label class=\"modal-form-label\" for=\"numberTrees\">", ":</label>\n\t\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"numberTrees\" type=\"number\" placeholder=\"0\" min=\"0\"/>\n\t\t\t\t\t</div>\n\t\t\t\t\t\n\t\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t\t<label class=\"modal-form-label\" for=\"numberNodes\">", ":</label>\n\t\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\"  value=\"", "\" id=\"numberNodes\" type=\"number\" placeholder=\"0\" min=\"0\"/>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"customization\">", "</label>\n\t\t\t\t\t<select id=\"customization-select\" class=\"modal-select\" name=\"customization\">\n\t\t\t\t\t\t<option class=\"modal-option\" value=\"1\">", "</option>\n\t\t\t\t\t\t<option class=\"modal-option\" value=\"0\">", "</option>\n\t\t\t\t\t</select>\n\t\t\t\t</div>\n\t\t\t\n\t\t\t\t<input id=\"edit-button\" class=\"add\" type=\"submit\" value=\"", "\">\n\t\t\t</form>\n\t\t</div>\n\t\t"])), BX.message('UP_TREE_ADMIN_SUBSCRIPTION_NAME'), data !== null ? data.level : '', BX.message('UP_TREE_ADMIN_TITLE'), BX.message('UP_TREE_ADMIN_PRICE'), data !== null ? data.price : '', BX.message('UP_TREE_ADMIN_PRICE'), BX.message('UP_TREE_ADMIN_NUMBER_TREES'), data !== null ? data.numberTrees : '', BX.message('UP_TREE_ADMIN_NUMBER_NODES'), data !== null ? data.numberNodes : '', BX.message('UP_TREE_ADMIN_ALLOW_CUSTOMIZATION'), BX.message('UP_TREE_ADMIN_ALLOW_CUSTOMIZATION_YES'), BX.message('UP_TREE_ADMIN_ALLOW_CUSTOMIZATION_NO'), data !== null ? 'Edit' : 'Add');
	    }
	  }]);
	  return RenderForm;
	}();
	...
	var SubscriptionTable = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(SubscriptionTable, null, [{
	    key: "render",
	    value: function render(data) {
	      var headingTable = main_core.Tag.render(_templateObject$2 || (_templateObject$2 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<li class=\"table-header\">\n\t\t\t\t<div class=\"table-head col col-1\">ID</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t</li>\n\t\t"])), BX.message('UP_TREE_ADMIN_SUBSCRIPTION'), BX.message('UP_TREE_ADMIN_PRICE'), BX.message('UP_TREE_ADMIN_NUMBER_TREES'), BX.message('UP_TREE_ADMIN_NUMBER_NODES'), BX.message('UP_TREE_ADMIN_CUSTOMIZATION'), BX.message('UP_TREE_ADMIN_STATUS'), BX.message('UP_TREE_ADMIN_ACTIONS'));
	...
	var UserSubscriptionsTable = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(UserSubscriptionsTable, null, [{
	    key: "render",
	    value: function render(data) {
	      var headingTable = main_core.Tag.render(_templateObject$4 || (_templateObject$4 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<li class=\"table-header\">\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t</li>\n\t\t"])), BX.message('UP_TREE_ADMIN_USER_ID'), BX.message('UP_TREE_ADMIN_SUBSCRIPTION_ID'), BX.message('UP_TREE_ADMIN_NUMBER_TREES'), BX.message('UP_TREE_ADMIN_NUMBER_NODES'), BX.message('UP_TREE_ADMIN_BUY_TIME'), BX.message('UP_TREE_ADMIN_ACTIONS'));
	...
	var RenderForm$1 = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(RenderForm, null, [{
	    key: "render",
	    value: function render(data) {
	      return main_core.Tag.render(_templateObject$6 || (_templateObject$6 = babelHelpers.taggedTemplateLiteral(["\n\t\t<div class=\"sign-up-modal\">\n\t\t\t<div class=\"logo-container\">\n\t\t\t\t<svg height=\"90px\" width=\"90px\" version=\"1.1\" id=\"_x32_\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" \n\t\t\t\tviewBox=\"0 0 512 512\"  xml:space=\"preserve\">\n\t\t\t\t\t<style type=\"text/css\">\n\t\t\t\t\t.st0{fill:#fff;}\n\t\t\t\t\t</style>\n\t\t\t\t\t<g>\n\t\t\t\t\t\t<path class=\"st0\" d=\"M465.771,234.587c0-26.914-10.749-51.289-28.142-69.166c0.629-4.688,1.075-9.437,1.075-14.301\n\t\t\t\t\t\tc0-54.151-40.625-98.726-93.05-105.14C319.308,17.754,281.874,0,240.206,0C160.476,0,95.853,64.624,95.853,144.361\n\t\t\t\t\t\tc0,0.422,0.062,0.821,0.062,1.236c-29.975,20.27-49.686,54.58-49.686,93.494c0,53.346,37.08,97.937,86.842,109.667\n\t\t\t\t\t\tc10.089,24.69,34.318,42.106,62.636,42.106c10.557,0,20.508-2.486,29.407-6.798V512h77.528v-83.988l30.236-51.657\n\t\t\t\t\t\tc30.95-2.256,57.097-21.766,68.743-49.033C439.087,313.128,465.771,277.022,465.771,234.587z M260.615,342.229\n\t\t\t\t\t\tc0.66,0.928,1.343,1.826,2.041,2.724l-3.43,1.396C259.725,344.984,260.208,343.625,260.615,342.229z M284.874,405.402v-40.579\n\t\t\t\t\t\tc7.181,4.366,15.076,7.642,23.492,9.622L284.874,405.402z\"/>\n\t\t\t\t\t</g>\n\t\t\t\t</svg>\n\t\t\t</div>\n\t\t\t\n\t\t\t<form class=\"details\">\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"title\">", "</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"title\" type=\"text\" />\n\t\t\t\t</div>\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"price\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"price\" type=\"number\" min=\"0\"/>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t<input id=\"edit-button\" class=\"add\" type=\"submit\" value=\"", "\">\n\t\t\t</form>\n\t\t</div>\n\t\t"])), BX.message('UP_TREE_ADMIN_PURCHASE_NAME'), data !== null ? data.TITLE : '', BX.message('UP_TREE_ADMIN_PRICE'), data !== null ? data.PRICE : '', data !== null ? 'Edit' : 'Add');
	    }
	  }]);
	  return RenderForm;
	}();
	...
	var RenderForm$3 = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(RenderForm, null, [{
	    key: "render",
	    value: function render(data) {
	      return main_core.Tag.render(_templateObject$a || (_templateObject$a = babelHelpers.taggedTemplateLiteral(["\n\t\t<div class=\"sign-up-modal\">\n\t\t\t<div class=\"logo-container\">\n\t\t\t\t<svg height=\"90px\" width=\"90px\" version=\"1.1\" id=\"_x32_\" xmlns=\"http://www.w3.org/2000/svg\" xmlns:xlink=\"http://www.w3.org/1999/xlink\" \n\t\t\t\tviewBox=\"0 0 512 512\"  xml:space=\"preserve\">\n\t\t\t\t\t<style type=\"text/css\">\n\t\t\t\t\t.st0{fill:#fff;}\n\t\t\t\t\t</style>\n\t\t\t\t\t<g>\n\t\t\t\t\t\t<path class=\"st0\" d=\"M465.771,234.587c0-26.914-10.749-51.289-28.142-69.166c0.629-4.688,1.075-9.437,1.075-14.301\n\t\t\t\t\t\tc0-54.151-40.625-98.726-93.05-105.14C319.308,17.754,281.874,0,240.206,0C160.476,0,95.853,64.624,95.853,144.361\n\t\t\t\t\t\tc0,0.422,0.062,0.821,0.062,1.236c-29.975,20.27-49.686,54.58-49.686,93.494c0,53.346,37.08,97.937,86.842,109.667\n\t\t\t\t\t\tc10.089,24.69,34.318,42.106,62.636,42.106c10.557,0,20.508-2.486,29.407-6.798V512h77.528v-83.988l30.236-51.657\n\t\t\t\t\t\tc30.95-2.256,57.097-21.766,68.743-49.033C439.087,313.128,465.771,277.022,465.771,234.587z M260.615,342.229\n\t\t\t\t\t\tc0.66,0.928,1.343,1.826,2.041,2.724l-3.43,1.396C259.725,344.984,260.208,343.625,260.615,342.229z M284.874,405.402v-40.579\n\t\t\t\t\t\tc7.181,4.366,15.076,7.642,23.492,9.622L284.874,405.402z\"/>\n\t\t\t\t\t</g>\n\t\t\t\t</svg>\n\t\t\t</div>\n\t\t\t<form class=\"details\">\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"subId\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"subId\" type=\"number\" placeholder=\"ID\" min=\"0\"/>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"countTrees\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"countTrees\" type=\"number\" min=\"0\"/>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"countNodes\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"countNodes\" type=\"number\" placeholder=\"0\" min=\"0\"/>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t\t<div class=\"input-container\">\n\t\t\t\t\t<label class=\"modal-form-label\" for=\"buyTime\">", ":</label>\n\t\t\t\t\t<input class=\"col-sm-12 with-placeholder\" value=\"", "\" id=\"buyTime\" type=\"datetime-local\" step=\"2\" placeholder=\"buyTime\" />\n\t\t\t\t</div>\n\t\t\t\n\t\t\t\n\t\t\t\t<input id=\"edit-button\" type=\"submit\" value=\"Edit\">\n\t\t\t</form>\n\t\t</div>\n\t\t"])), BX.message('UP_TREE_ADMIN_SUBSCRIPTION_ID'), data.subscriptionId, BX.message('UP_TREE_ADMIN_NUMBER_TREES'), data.countTrees, BX.message('UP_TREE_ADMIN_NUMBER_NODES'), data.countNodes, BX.message('UP_TREE_ADMIN_BUY_TIME'), data.buyTime);
	    }
	  }]);
	  return RenderForm;
	}();
	...
	var UsersTable = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(UsersTable, null, [{
	    key: "render",
	    value: function render(data) {
	      var headingTable = main_core.Tag.render(_templateObject$c || (_templateObject$c = babelHelpers.taggedTemplateLiteral(["\n\t\t\t<li class=\"table-header\">\n\t\t\t\t<div class=\"table-head col col-1\">ID</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t\t<div class=\"table-head col col-1\">", "</div>\n\t\t\t</li>\n\t\t"])), BX.message('UP_TREE_ADMIN_EMAIL'), BX.message('UP_TREE_ADMIN_NAME'), BX.message('UP_TREE_ADMIN_SURNAME'), BX.message('UP_TREE_ADMIN_STATUS'), BX.message('UP_TREE_ADMIN_ACTIONS'));
	    ...
	    value: function renderList(data) {
	      return data.map(function (user) {
	        return main_core.Tag.render(_templateObject3$4 || (_templateObject3$4 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t<li class=\"table-row\">\n\t\t\t\t\t<div class=\"col col-1\" data-label=\"Id\">", "</div>\n\t\t\t\t\t<div class=\"col col-1\" data-label=\"Title\">", "</div>\n\t\t\t\t\t<div class=\"col col-1\" data-label=\"Price\">", "</div>\n\t\t\t\t\t<div class=\"col col-1\" data-label=\"Price\">", "</div>\n\t\t\t\t\t<div class=\"col col-1\" data-label=\"Price\">", "</div>\n\t\t\t\t\t<div class=\"col col-1\">\n\t\t\t\t\t<ul class=\"action-list\">\n\t\t\t\t\t\t\t<li class=\"action-item\">\n\t\t\t\t\t\t\t\t<label class=\"checkbox\">\n\t\t\t\t\t\t\t\t\t<input class=\"input-checkbox\" data-btn-id=\"", "\" ", " type=\"checkbox\" />\n\t\t\t\t\t\t\t\t\t<svg viewBox=\"0 0 21 18\">\n\t\t\t\t\t\t\t\t\t\t<symbol id=\"tick-path", "\" viewBox=\"0 0 21 18\" xmlns=\"http://www.w3.org/2000/svg\">\n\t\t\t\t\t\t\t\t\t\t\t<path d=\"M5.22003 7.26C5.72003 7.76 7.57 9.7 8.67 11.45C12.2 6.05 15.65 3.5 19.19 1.69\" fill=\"none\" stroke-width=\"2.25\" stroke-linecap=\"round\" stroke-linejoin=\"round\" />\n\t\t\t\t\t\t\t\t\t\t</symbol>\n\t\t\t\t\t\t\t\t\t\t<defs>\n\t\t\t\t\t\t\t\t\t\t\t<mask id=\"tick", "\">\n\t\t\t\t\t\t\t\t\t\t\t\t<use class=\"tick mask\" href=\"#tick-path", "\" />\n\t\t\t\t\t\t\t\t\t\t\t</mask>\n\t\t\t\t\t\t\t\t\t\t</defs>\n\t\t\t\t\t\t\t\t\t\t<use class=\"tick\" href=\"#tick-path", "\" stroke=\"currentColor\" />\n\t\t\t\t\t\t\t\t\t\t<path fill=\"white\" mask=\"url(#tick", ")\" d=\"M18 9C18 10.4464 17.9036 11.8929 17.7589 13.1464C17.5179 15.6054 15.6054 17.5179 13.1625 17.7589C11.8929 17.9036 10.4464 18 9 18C7.55357 18 6.10714 17.9036 4.85357 17.7589C2.39464 17.5179 0.498214 15.6054 0.241071 13.1464C0.0964286 11.8929 0 10.4464 0 9C0 7.55357 0.0964286 6.10714 0.241071 4.8375C0.498214 2.39464 2.39464 0.482143 4.85357 0.241071C6.10714 0.0964286 7.55357 0 9 0C10.4464 0 11.8929 0.0964286 13.1625 0.241071C15.6054 0.482143 17.5179 2.39464 17.7589 4.8375C17.9036 6.10714 18 7.55357 18 9Z\" />\n\t\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t\t<svg class=\"lines\" viewBox=\"0 0 11 11\">\n\t\t\t\t\t\t\t\t\t\t<path d=\"M5.88086 5.89441L9.53504 4.26746\" />\n\t\t\t\t\t\t\t\t\t\t<path d=\"M5.5274 8.78838L9.45391 9.55161\" />\n\t\t\t\t\t\t\t\t\t\t<path d=\"M3.49371 4.22065L5.55387 0.79198\" />\n\t\t\t\t\t\t\t\t\t</svg>\n\t\t\t\t\t\t\t\t</label>\n\t\t\t\t\t\t\t</li>\n\t\t\t\t\t\t</ul>\n\t\t\t\t\t</div>\n\t\t\t\t</li>\n\t\t\t"])), user.id, BX.util.htmlspecialchars(user.email), BX.util.htmlspecialchars(user.name), BX.util.htmlspecialchars(user.lastName), user.active ? 'Активен' : 'Неактивен', user.id, user.active ? "checked" : '', user.id, user.id, user.id, user.id, user.id);
	      });
	    }
	  }]);
	  return UsersTable;
