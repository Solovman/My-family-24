...
(function (exports,main_core) {
	          ...
	          onPopupShow: function onPopupShow() {
	            ...
	            if (data !== null) {
	              BX.bind(BX('edit-button'), 'click', function (event) {
	                ...
	                Requests.addPurchase(newPurchase).then(function (result) {
	                  new Admin({
	                    rootNodeId: 'table'
	                  });
	                  _this.destroy();
	...
	var _templateObject$a, _templateObject2$4, _templateObject3$4, _templateObject4, _templateObject5;
