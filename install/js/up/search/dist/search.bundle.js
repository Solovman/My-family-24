...
(function (exports,main_core) {
	...
	var Form = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(Form, null, [{
	    key: "render",
	    value: function render(name, surname) {
	  ...
	  babelHelpers.createClass(Search, [{
	    ...
	    value: function renderListUser() {
	      ...
	      if (this.usersPersons.foundUsers) {
	        var list = main_core.Tag.render(_templateObject3 || (_templateObject3 = babelHelpers.taggedTemplateLiteral(["\n\t\t\t\t<main class=\"leaderboard__profiles\">\n\t\t\t\t\t", "\n\t\t\t\t</main>\n\t\t\t\t"])), this.usersPersons.foundUsers.map(function (user) {
