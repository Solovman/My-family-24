		...
		if (this.usersPersons.foundUsers) {
			const list = Tag.render`
				<main class="leaderboard__profiles">
					${this.usersPersons.foundUsers.map(user => `
