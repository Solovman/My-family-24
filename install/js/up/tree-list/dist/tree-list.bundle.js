...
(function (exports,main_core) {
	...
	var TreeList = /*#__PURE__*/function () {
	  ...
	  babelHelpers.createClass(TreeList, [{
	    ...
	    key: "handleUpdateSearchStatusButtonClick",
	    value: function handleUpdateSearchStatusButtonClick(element) {
	      var _this4 = this;
	      var treeId = element.dataset.btnId;
	      console.log(treeId);
	      if (treeId !== '') {
	        if (element.dataset.btnType === 'activated') {
	          var confirmUpdate = confirm("Do you want to activate search in this tree? Your information about the tree will be available to other people");
	          if (confirmUpdate) {
	            this.updateSecuritySearchStatus(treeId, 0).then(function () {
	              _this4.reload();
	            })["catch"](function (error) {
	          ...
	          var _confirmUpdate = confirm("Do you want to disable searching in this tree? Your information about the tree will not be available to other people");
	          if (_confirmUpdate) {
	            this.updateSecuritySearchStatus(treeId, 1).then(function () {
	              _this4.reload();
	            })["catch"](function (error) {
	              console.error('Error when update security status a tree:', error);
	            });
